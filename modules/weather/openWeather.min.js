...
plugin.settings=$.extend({},defaults,options);var s=plugin.settings;apiURL='//api.openweathermap.org/data/2.5/weather?lang='+s.lang;apiURL+='&q='+s.city.replace(' ','');apiURL+='&appid='+s.key;var formatTime=function(unixTimestamp){var milliseconds=unixTimestamp*1000;var date=new Date(milliseconds);var hours=date.getHours();if(hours>12){hoursRemaining=24-hours;hours=12-hoursRemaining}
