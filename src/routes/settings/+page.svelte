...
<div class="min-h-screen bg-gray-50 p-2 sm:p-4 md:p-8 dark:bg-gray-900">
	<div class="mx-auto max-w-6xl">
		<div class="rounded-lg bg-white shadow-lg dark:bg-gray-800">
			<!-- Header -->
			<div
				class="flex flex-col gap-4 border-b border-gray-200 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 dark:border-gray-700"
			>
				<div class="flex items-center gap-3">
					<Settings size={24} class="text-gray-700 dark:text-gray-300" />
					<h1 class="text-xl font-bold text-gray-900 sm:text-2xl dark:text-gray-100">Settings</h1>
				</div>
				<div class="flex w-full gap-2 sm:w-auto">
					<button
						onclick={handleBackToMirror}
						class="flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-700 hover:bg-gray-50 sm:py-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
					>
						<ArrowLeft size={18} />
						<span class="hidden sm:inline">Back to Mirror</span>
						<span class="sm:hidden">To Mirror</span>
					</button>
					<button
						onclick={saveConfig}
			...
			{#if loading}
				<div class="p-8 text-center text-gray-500 sm:p-12 dark:text-gray-400">
			...
			{:else if config}
				<div class="flex flex-col lg:flex-row">
					<!-- Mobile Tab Selector -->
					<div
						class="border-b border-gray-200 bg-gray-50 lg:hidden dark:border-gray-700 dark:bg-gray-800"
					>
						<select
							bind:value={activeTab}
							class="w-full border-0 bg-gray-50 px-4 py-3 text-base font-medium text-gray-900 focus:ring-0 focus:outline-none dark:bg-gray-800 dark:text-gray-100"
						>
							{#each tabs as tab}
					...
					<div
						class="hidden w-64 border-r border-gray-200 bg-gray-50 lg:block dark:border-gray-700 dark:bg-gray-800"
					>
							...
							<div class="space-y-4 sm:space-y-6">
								...
								<div class="space-y-6">
									{#each areaOrder as area}
										...
										<div class="space-y-3">
											<h3
												class="border-b border-gray-200 pb-2 text-base font-semibold text-gray-800 dark:border-gray-700 dark:text-gray-200"
											>
												{getAreaLabel(area)}
											</h3>
											...
											<div class="space-y-2">
												{#if componentsInArea.length === 0}
													<div
														class="rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 py-6 text-center text-sm text-gray-400 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-500"
													>
												...
												{:else}
													{#each componentsInArea as { comp, index }, localIndex}
														...
														<div
															class="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-4 transition-colors hover:border-gray-300 sm:flex-row sm:items-center sm:justify-between dark:border-gray-700 dark:bg-gray-800 dark:hover:border-gray-600"
														>
																...
																<div class="flex flex-col">
																	<button
																		...
																		class="p-0.5 transition-colors {canMoveUp(globalIndex)
																			? 'cursor-pointer text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400'
															...
															<div class="flex items-center gap-4">
																<select
																	...
																	class="w-full cursor-pointer rounded border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 sm:w-auto sm:py-1 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
																>
